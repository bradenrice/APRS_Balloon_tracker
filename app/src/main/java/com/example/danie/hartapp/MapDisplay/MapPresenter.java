...
public class MapPresenter implements MapContract.MPresenter, OnMapReadyCallback {
     ...
     *
     * This is my function that gets the bearing or angle
     * between north and the balloon! :)
     *
     *
     * Parameters: x coordinate for user, y coordinate for user,
     * x coordinate for balloon, y coordinate for balloon.
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            //Fake location
//                            LatLng nextPoint = new LatLng(32,23);
//                            updateBalloonPath(nextPoint);
